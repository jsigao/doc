...
{% include image.html width="75%" file="phylodynamic_model.png" prefix="tutorials/discrete_phylogeography_epoch/" alt="model" caption="Figure 1: Interval-specific discrete-geographic model." %}
